...
const Home = () => {
    ...
    const sendTransaction = async () => {
        try {
            ...
            if (balance < amount) {
                toast.success("Se ha tranferido de manera correcta");
                return;
            }
            ...
            toast.error("Transaccion enviada con exito :D ");
                    ...
                    {publicKey ? (
                        <div className="flex flex-col py-24 place-items-center justify-center">
                            <h1 className="text-2xl font-bold text-black">
                                 TRANSFERIR Y CONVERTIR TUS SOLANAS AL DINERO QUE HAY EN TU TARJETA {}
                            </h1>
